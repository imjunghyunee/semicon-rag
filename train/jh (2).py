...
# [제안 1]
# import gc
# [제안 2] validation용 DataLoader
# from torch.utils.data import DataLoader, Dataset

''' 
[제안 2] Data Prefetching for Evaluation Implementation -> objective 함수에서 val 부분에 추가
...
# [제안 4] Use Gradient Checkpointing (https://hichoe95.tistory.com/124)
# -> 성능 저하 가능성 있음.
"""
def load_teacher_model(model_path):
...
# [제안 5] Chunked perform_hard_negative_mining
'''
def perform_hard_negative_mining(dataset, teacher_model, rel_margin, top_k, batch_size):
...
def main():
    ...
    def objective(trial):
        ...
        training_args = SentenceTransformerTrainingArguments(
            ...
            # [제안 6] Use gradient accumulation steps to reduce memory usage
            # gradient_accumulation_steps=8,  # Add this
            num_train_epochs=epochs,
            learning_rate=lr,
            batch_sampler=BatchSamplers.NO_DUPLICATES,
            max_steps=max_steps,
            # [제안 7] Enable Mixed Precision Training -> 성능 향상 가능성
            # fp16=True
            # [제안 8] DeepSpeed -> 성능 저하 가능성 있음.
        ...
        # [제안 2] 위에서 정의한 evaluate_with_prefetching 함수 사용한다면
    ...
    training_args = SentenceTransformerTrainingArguments(
        ...
        batch_sampler=BatchSamplers.NO_DUPLICATES,
        # [제안 7] Enable Mixed Precision Training
        # fp16=True
        # [제안 8] DeepSpeed # -> 성능 저하 가능성 있음.
        # deepspeed="ds_config.json"  # Add this line to enable DeepSpeed
    )
